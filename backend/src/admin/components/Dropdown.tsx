import { ProductVariant } from "medusa-react";

// const Dropdown = ({variants}: ProductVariant[]) => {
const Dropdown = (options: any) => {
  console.log("options", options);

  options.options.map(option => {console.log("option", option);
  }); 

  if (!options) return
  
  return (
    <div className="relative inline-block text-left align-right">
      <div>
